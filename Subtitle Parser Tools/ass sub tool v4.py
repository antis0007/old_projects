...
def loadcharacters():
    ...
    character_list_tkvar.set(character_list)
...
character_list_tkvar = tkinter.StringVar(value=character_list)#create a tkinter stringvar for modifications
...
for char in character_list:
    button = Button(root, text=char, command=lambda x=char: func(x))
    button.pack()
